			...
			<div className='flex flex-col items-center justify-evenly w-full max-w-7xl mb-5'>
				...
				<div className='flex justify-between w-4/5 items-center font-bold mt-5'>
					<h2 className='text-xl'>
						Your fDAI balance : {balance1.data?.formatted.substring(0, 7)}
					</h2>
					<h2 className='text-xl'>Reward per token per day: {1}</h2>
					<h2 className='text-xl'>
						Your RDT balance : {balance2.data?.formatted}
					</h2>
				</div>

				<div className='flex justify-evenly w-4/5 items-center'>
					<Card2 title='Stake fDAI' description='q' balance={balance1} />
					<Card2 title='Unstake fDAI' description='q' balance={balance1} />
				</div>
